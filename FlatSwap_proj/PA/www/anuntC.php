<center><h2>Anunturi Chirie</h2></center>
<?php
connectDB();
...
AND contractv.id_serv=servicii.id_serv AND contractv.id_angajat=angajat.id_angajat  AND contractv.realizat='0' AND servicii.id_serv ='6'";
...
<div id="pret">
<span>Pret:<?php echo $pret/200?><i class="fa fa-eur"></i></span>
</div>
</div>
<?php }
  closeDB($mysqli);
